"""restore_job_deleted (audit) + permiso restore.delete en catálogo RBAC."""
...
revision: str = "0018_restore_job_delete_rbac"
down_revision: Union[str, None] = "0017_alembic_version_widen"
...
def upgrade() -> None:
    with op.get_context().autocommit_block():
        op.execute(
            sa.text("ALTER TYPE audit_action ADD VALUE IF NOT EXISTS 'restore_job_deleted'")
        )
